...
const connect = (0, swagger_routes_express_1.connector)(controllers, apiDefinition, options);
// Configure environment
if (process.env.NODE_ENV) {
    envConfig_1.default.loadConfig(process.env.NODE_ENV);
}
else {
    throw new Error('ENV configuration name missing');
}
// Sync Models
const models_1 = __importStar(require("./src/models"));
models_1.default.sequelize.authenticate();
(function () {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, models_1.migrateAll)();
